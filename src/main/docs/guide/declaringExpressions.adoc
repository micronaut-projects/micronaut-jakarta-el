...
<1> A public static method is a function under its own name.
<2> `@ELFunction` gives a function another name.
...
<1> An ordinary bean.
<2> A public instance method is a function, invoked on the instance.
<3> A public static method is a function, invoked directly.

snippet::example.PricingExpressions[project-base="doc-examples/example", title="PricingExpressions"]

<1> The bean is declared like any class of functions.
