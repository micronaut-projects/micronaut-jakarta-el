...
public final class ELNodes {
    ...
    // one case per node of the grammar: the branching is the grammar, and naming each case as its own
    // method would spread the canonical form of an expression across the file
