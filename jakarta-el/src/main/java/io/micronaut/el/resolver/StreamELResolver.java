...
public final class StreamELResolver extends ELResolver implements ELMethodExecutor {
    ...
    private static final String SORTED_NAME = "sorted";
    private static final String SUBSTREAM_NAME = "substream";
    ...
    private enum StreamMethod implements ELMethod {
        ...
        SORTED_NO_ARGS(SORTED_NAME, ELStream.class),
        SORTED(SORTED_NAME, ELStream.class, LambdaExpression.class),
        ...
        SUBSTREAM_ONE(SUBSTREAM_NAME, ELStream.class, Object.class),
        SUBSTREAM_TWO(SUBSTREAM_NAME, ELStream.class, Object.class, Object.class),
        TO_ARRAY("toArray", Object[].class),
        TO_LIST("toList", List.class),
        REDUCE_ONE(REDUCE_NAME, ELOptional.class, LambdaExpression.class),
        REDUCE_TWO(REDUCE_NAME, ELOptional.class, Object.class, LambdaExpression.class),
        ...
        private static StreamMethod forName(String name, int arity) {
            return switch (name) {
                ...
                case SORTED_NAME -> arity == 0 ? SORTED_NO_ARGS : arity == 1 ? SORTED : null;
                case "forEach" -> FOR_EACH;
                case "peek" -> PEEK;
                case "iterator" -> ITERATOR;
                case "limit" -> LIMIT;
                case SUBSTREAM_NAME -> arity == 1 ? SUBSTREAM_ONE : arity == 2 ? SUBSTREAM_TWO : null;
                case "toArray" -> TO_ARRAY;
                case "toList" -> TO_LIST;
                case REDUCE_NAME -> arity == 1 ? REDUCE_ONE : arity == 2 ? REDUCE_TWO : null;
