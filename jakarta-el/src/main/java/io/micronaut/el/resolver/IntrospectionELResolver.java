...
public final class IntrospectionELResolver extends ELResolver implements ELMethodExecutor {
    ...
    // the bean method is not serializable, and never reaches a stream: this resolver binds no function,
    // so nothing of it is held in the state an expression writes out, and the method is not reusable
