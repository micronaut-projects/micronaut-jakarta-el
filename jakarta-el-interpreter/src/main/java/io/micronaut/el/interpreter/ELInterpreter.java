...
final class ELInterpreter {
    ...
    // one walk of the tree, binding every kind of node that can name a function; the branching is the
    // shape of the tree rather than logic that can be lifted out of it
    ...
    static final class MethodCallSite {
        ...
        // Resolved is a record of final fields, so publishing the reference is publishing the whole of it
